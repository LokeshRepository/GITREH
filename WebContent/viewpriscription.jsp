...
<center><br>
	...
	<table BORDER="35">
			...
			<%
			try{
				Connection con12= Demo.getConnect();
			PreparedStatement pstmt665=con12.prepareStatement("select * from priscription");
			ResultSet rs11=pstmt665.executeQuery();
			while(rs11.next())
			{
			%>
			<tr>
