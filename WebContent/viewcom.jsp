...
<br>
	...
	<table BORDER="50">
		...
		<br><br>	
			...
			<th>Aarogya Vibhag Comment</th>
			<th>Specialist doctor Comment</th>
			<th>Specialist doctor Priscription</th>
			...
			PreparedStatement pstmt=con.prepareStatement("select * from comments");
